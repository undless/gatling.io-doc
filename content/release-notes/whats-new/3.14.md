...
Gatling now supports dynamic per-virtual-user HTTP proxy credentials, see the [HTTP proxy documentation]({{< ref "/reference/script/protocols/http/protocol/#proxy" >}}) for more details.
